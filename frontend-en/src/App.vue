  ...
  <div id="app">
    ...
    <div v-else class="app-layout">
      <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
        <div class="brand">
          <div class="brand-icon"><i class="el-icon-s-data"></i></div>
          <div class="brand-text">
            <strong>Aquatic Supervision</strong>
...
export default {
  ...
  computed: {
    pageTitle() {
      const titles = {
        '/home': 'Dashboard', '/batches': 'Batch List', '/batches/create': 'Material Intake Registration',
        '/batches/scan': 'Scan Entry', '/inspection/workbench': 'Inspection Workbench',
        '/inspection/records': 'Inspection Records Archive', '/release': 'Release Management',
        '/traceability': 'Traceability Center', '/traceability/preview': 'Public Trace Preview',
        '/users': 'User Management', '/enterprise': 'Enterprise Info',
        '/announcements': 'System Announcements', '/profile': 'Profile'
      };
      const path = this.$route.path;
      if (path.startsWith('/batches/') && !titles[path]) return 'Batch Detail';
    ...
    userRoleName() {
      const u = this.getUser();
      const map = { ADMIN: 'Administrator', PROD_MANAGER: 'Production Manager', INSPECTOR: 'Quality Inspector', OPERATOR: 'Operator' };
